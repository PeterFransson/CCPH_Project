...
function Run_RO_C_F_CCPH(par::Array{Float64,1},weatherts_F::WeatherTS,
    ...
    Nₛ,rₘ,a_Jmax,Kₓₗ₀,Nₛ_C,i,r_α = par[1:7]    
...
function Post_distri_RO_C_F_CCPH(par::Array{Float64,1},RO_data::RO_raw_data)    
    try
        ...
        GPP_model_F,GPP_model_C,EC_model_F,EC_model_C,Nₘ_f_model_F,Nₘ_f_model_C = Run_RO_C_F_CCPH(par,weatherts_F,weatherts_C,data_F,data_C)              
...
function run_opt()    
    ...
    #Nₛ,rₘ,a_Jmax,Kₓₗ₀,Nₛ_C,i,r_α,X0,τ,Smax,a_GPP,b_GPP,a_Ec,b_Ec
